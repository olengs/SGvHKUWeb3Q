...
POLYMARKET = {
    "Mar 17": [
        ("66-68k",  66000,  68000, 0.0015),
        ("68-70k",  68000,  70000, 0.0100),
        ("70-72k",  70000,  72000, 0.0625),
        ("72-74k",  72000,  74000, 0.4250),
        ("74-76k",  74000,  76000, 0.4350),
        ("76-78k",  76000,  78000, 0.0790),
        ("78-80k",  78000,  80000, 0.0115),
        (">80k",    80000,   None, 0.0035),
    ],
    "Mar 18": [
        ("<62k",     None,  62000, 0.0015),
        ("62-64k",  62000,  64000, 0.0035),
        ("64-66k",  64000,  66000, 0.0060),
        ("66-68k",  66000,  68000, 0.0215),
        ("68-70k",  68000,  70000, 0.0415),
        ("70-72k",  70000,  72000, 0.1550),
        ("72-74k",  72000,  74000, 0.2800),
        ("74-76k",  74000,  76000, 0.2750),
        ("76-78k",  76000,  78000, 0.1650),
        ("78-80k",  78000,  80000, 0.0540),
        (">80k",    80000,   None, 0.0290),
    ],
    "Mar 19": [
        ("<62k",     None,  62000, 0.0030),
        ("62-64k",  62000,  64000, 0.0045),
        ("64-66k",  64000,  66000, 0.0160),
        ("66-68k",  66000,  68000, 0.0335),
        ("68-70k",  68000,  70000, 0.0800),
        ("70-72k",  70000,  72000, 0.1600),
        ("72-74k",  72000,  74000, 0.2300),
        ("74-76k",  74000,  76000, 0.2200),
        ("76-78k",  76000,  78000, 0.1500),
        ("78-80k",  78000,  80000, 0.0820),
        (">80k",    80000,   None, 0.0540),
    ],
    "Mar 20": [
        ("<62k",     None,  62000, 0.0050),
        ("62-64k",  62000,  64000, 0.0140),
        ("64-66k",  64000,  66000, 0.0255),
        ("66-68k",  66000,  68000, 0.0435),
        ("68-70k",  68000,  70000, 0.0950),
        ("70-72k",  70000,  72000, 0.1500),
        ("72-74k",  72000,  74000, 0.2150),
        ("74-76k",  74000,  76000, 0.2100),
        ("76-78k",  76000,  78000, 0.1500),
        ("78-80k",  78000,  80000, 0.0925),
        (">80k",    80000,   None, 0.0740),
    ],
    "Mar 22": [
        ("<62k",     None,  62000, 0.0170),
        ("62-64k",  62000,  64000, 0.0205),
        ("64-66k",  64000,  66000, 0.0305),
        ("66-68k",  66000,  68000, 0.0550),
        ("68-70k",  68000,  70000, 0.0950),
        ("70-72k",  70000,  72000, 0.1400),
        ("72-74k",  72000,  74000, 0.1700),
        ("74-76k",  74000,  76000, 0.1850),
        ("76-78k",  76000,  78000, 0.1350),
        ("78-80k",  78000,  80000, 0.0940),
        (">80k",    80000,   None, 0.1060),
    ],
    "Mar 23": [
        ("<64k",     None,  64000, 0.0260),
        ("64-66k",  64000,  66000, 0.0380),
        ("66-68k",  66000,  68000, 0.0590),
        ("68-70k",  68000,  70000, 0.1050),
        ("70-72k",  70000,  72000, 0.1300),
        ("72-74k",  72000,  74000, 0.1550),
        ("74-76k",  74000,  76000, 0.1700),
        ("76-78k",  76000,  78000, 0.1250),
        ("78-80k",  78000,  80000, 0.1050),
        ("80-82k",  80000,  82000, 0.0750),
        (">82k",    82000,   None, 0.0750),
    ],
}
